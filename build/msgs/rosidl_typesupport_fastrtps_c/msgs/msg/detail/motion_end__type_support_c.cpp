...
#include "msgs/msg/detail/motion_end__rosidl_typesupport_fastrtps_c.h"
...
using _MotionEnd__ros_msg_type = msgs__msg__MotionEnd;
...
size_t get_serialized_size_msgs__msg__MotionEnd(
  const void * untyped_ros_message,
...
static uint32_t _MotionEnd__get_serialized_size(const void * untyped_ros_message)
{
  return static_cast<uint32_t>(
    get_serialized_size_msgs__msg__MotionEnd(
      untyped_ros_message, 0));
}

ROSIDL_TYPESUPPORT_FASTRTPS_C_PUBLIC_msgs
size_t max_serialized_size_msgs__msg__MotionEnd(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = msgs__msg__MotionEnd;
    is_plain =
      (
...
static size_t _MotionEnd__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_msgs__msg__MotionEnd(
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_c, msgs, msg, MotionEnd)() {
